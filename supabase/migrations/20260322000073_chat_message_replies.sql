-- ============================================================
-- Chat message replies (Telegram-style)
-- ============================================================
...
-- Replace send_chat_message with optional reply target.
...
REVOKE ALL ON FUNCTION public.send_chat_message(UUID, TEXT, TEXT, TEXT, INTEGER, TEXT, UUID) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.send_chat_message(UUID, TEXT, TEXT, TEXT, INTEGER, TEXT, UUID) TO authenticated;
